...
re_han_default = re.compile("([\u4E00-\u9FD5\u3400-\u4DBF\U00020000-\U0002A6DF\U0002A700-\U0002B73F\U0002B740-\U0002B81F\U0002B820-\U0002CEAFa-zA-Z0-9]+)", re.U)
re_skip_default = re.compile("(\r\n|\s)", re.U)
re_han_cut_all = re.compile("([\u4E00-\u9FD5\u3400-\u4DBF\U00020000-\U0002A6DF\U0002A700-\U0002B73F\U0002B740-\U0002B81F\U0002B820-\U0002CEAF]+)", re.U)
re_skip_cut_all = re.compile("[^a-zA-Z0-9]", re.U)
    ...
    def initialize(self, dictionary=None):
        ...
        with self.lock:
            ...
            # default dictionary
                ...
                cache_file = "jieba.hakka.cache"
            # custom dictionary
            else:
                cache_file = "jieba.hakka.u%s.cache" % md5(
